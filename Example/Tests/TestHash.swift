...
class TestHash: XCTestCase {
    func testHash() {
        ...
        XCTAssert(try! message |> ripemd160 == "8099ed424ffa0d81a42f75b61aff1f22ef7bfd11" |> fromHex)
        XCTAssert(try! message |> sha160 == "0c248790270625fabd126d61bffb78625bf191c7" |> fromHex)
        XCTAssert(try! message |> sha256 == "b34ae13c097ec7a206b515b0cc3ff4b2c2f4e0fce30298604be140cdc7a76b74" |> fromHex)
        XCTAssert(try! message |> sha512 == "a26171d120b6e921e28c98c94a8a9ef540bb642b1da24b7aed830401d180ee62f2297a0f91f6b218539f04ae8db70779e7241e66e9d92f97bf75d20d6b23720a" |> fromHex)
        XCTAssert(try! message |> bitcoin256 == "032ba0f612f1564b19df42bbb611f6ca0bbc2a5a7553e576babeb5f88429cb2a" |> fromHex)
        XCTAssert(try! message |> bitcoin160 == "87c1d0bb4d6148c837463b3bedc72c260d2dcff5" |> fromHex)
