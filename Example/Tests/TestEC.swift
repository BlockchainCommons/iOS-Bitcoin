...
class TestEC: XCTestCase {
    func testECPrivateKeyNew() {
        let f = base16Decode >>> newECPrivateKey >>> base16Encode
    ...
    func testToECPublicKey() {
        let f = { base16Decode >>> toECPrivateKey >>> toECPublicKey(isCompressed: $0) >>> base16Encode }
    ...
    func testToECPaymentAddress() {
        let f = { base16Decode >>> toECPublicKey >>> toECPaymentAddress(version: $0) }
    ...
    func testToWIF() {
        let f = base16Decode >>> toECPrivateKey >>> toWIF
        let g = { base16Decode >>> toECPrivateKey >>> toWIF(version: .mainnet, isCompressed: $0) }
    ...
    func testWIFToECPrivateKey() {
        let f = wifToECPrivateKey >>> base16Encode
    ...
    func testWIFToECPublicKey() {
        let f = wifToECPrivateKey >>> toECPublicKey >>> base16Encode
        let g = { wifToECPrivateKey >>> toECPublicKey(isCompressed: $0) >>> base16Encode }
