...
class TestFormats: XCTestCase {
    ...
    func testBase16Hash() {
        let hashData = Data([0x18, 0x5f, 0x8d, 0xb3, 0x22, 0x71, 0xfe, 0x25, 0xf5, 0x61, 0xa6, 0xfc, 0x93, 0x8b, 0x2e, 0x26, 0x43, 0x06, 0xec, 0x30, 0x4e, 0xda, 0x51, 0x80, 0x07, 0xd1, 0x76, 0x48, 0x26, 0x38, 0x19, 0x69])
        ...
        XCTAssertThrowsError(try Data([0x01, 0x02]) |> toBitcoinHash == hash) // Wrong length
